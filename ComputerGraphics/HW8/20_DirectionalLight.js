...
- Keyboard controls:
    ...
    - 'r' to reset arcball
    - '1'-'5' to set the number of toon shading levels
- Toon shading (cel shading) with directional light
----------------------------------------------------------------------------------*/
...
let toonLevels = 3;             // Default toon shading levels
...
function render() {
    ...
    shader.setInt('u_toonLevels', toonLevels); // Set toon levels
...
async function main() {
    try {
        ...
        // Set up cylinder with smooth shading
        ...
        // Set up directional light pointing from (1.0, 0.25, 0.5) toward origin
        const normalizedDirection = vec3.create();
        vec3.normalize(normalizedDirection, vec3.fromValues(1.0, 0.25, 0.5));
        shader.setVec3("light.direction", normalizedDirection);
        ...
        setupText(canvas, "press '1'-'5' to set toon levels", 6);
